...
public class AIPathfinding : MonoBehaviour
{
    ...
    void CheckObstruction()
    {
        ...
        checkFR = Physics2D.Raycast(aiPosition + checkOffsetFR, transform.TransformDirection(Vector3.down), checkDistance*2, layerMask); //Check Front-Right downward from the character.
    ...
    void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay(aiPosition + checkOffsetFR, Vector3.down * checkDistance*2);
